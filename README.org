...
** Rust  
First, install the following Rust components:

- Rust itself
- the linter [[https://github.com/rust-lang/rust-clippy][Clippy]]
- the language server

#+begin_src shell
  $ pacman -S mingw-w65-x86_64-rust
  $ rustup update
  $ set PATH=%PATH%;C:\users\dominik\.cargo\bin\
